...
//comparator compares the values inputed and swaps them is if
...
//This block contains the main code for batcher sort.
void batcher_sort(Stats *stats, uint32_t *A, uint32_t n) {
    ...
    for (uint32_t i = 0; i < sizeof(uint32_t) * 8; i++) {
        ...
        //this conditional returns true if bit index 0 is set to 1
